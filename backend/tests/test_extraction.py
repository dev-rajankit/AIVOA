...
@pytest.mark.anyio
async def test_missing_fields_remain_null():
...
@pytest.mark.anyio
async def test_api_dosage_form():
...
@pytest.mark.anyio
async def test_fdf_dosage_form():
...
@pytest.mark.anyio
async def test_invalid_llm_output_rejected():
...
@pytest.mark.anyio
async def test_provider_failure_no_fabricated_data():
...
@pytest.mark.anyio
async def test_empty_input_returns_empty_extraction():
...
@pytest.mark.anyio
async def test_long_input_rejected():
...
@pytest.mark.anyio
async def test_prompt_injection_treated_as_data():
...
@pytest.mark.anyio
async def test_graph_integration_with_fake_provider():
...
@pytest.mark.anyio
async def test_extraction_node_factory_binds_model():
    ...
    await node({"user_input": "test input"})
    assert ModelCapturingProvider.captured_model == "my-custom-model"


@pytest.mark.anyio
async def test_extraction_node_passes_system_prompt():
